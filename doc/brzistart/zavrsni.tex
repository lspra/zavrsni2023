...
Ispis završava praznim retkom. %TODO
...
\end{verbatim}
ona se prevodi u slijedeći C kod: 
\begin{verbatim}
    #include <stdio.h>
    #include <stdlib.h>
...
Još jedna moguća ulazna datoteka je:
\begin{verbatim}
    main(q = uint32) {
        x = int8[32];
        y = int8;
...
\begin{sazetak}
    Cilj rada bio je istražiti elemente programskih jezika, definirati novi objektno orijentirani programski jezik i razviti prevoditelj za taj jezik.
    ...
    funkcije za generiranje koda u ciljni program.
...
\begin{abstract}
The goal of this paper was to explore the elements of programming languages, 
define a new object-oriented programming language and develop a compiler for that language.
...
functions that generate code of the target program.
